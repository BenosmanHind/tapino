...
<html lang="en">
    ...
    <head>
        ...
        <title>Tapino- Admin dashboard</title>
        <!-- Favicon icon -->
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<li class="nav-label first">Main Menu</li>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{ asset('/admin/professionals') }}" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
							...
							<span class="nav-text">Professionals</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="{{asset('admin/professionals/create')}}">Ajouter</a></li>
                            <li><a href="{{asset('admin/professionals')}}">Tous</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{ asset('/admin/customers') }}" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                                <path d="M6,2 L18,2 C19.6568542,2 21,3.34314575 21,5 L21,19 C21,20.6568542 19.6568542,22 18,22 L6,22 C4.34314575,22 3,20.6568542 3,19 L3,5 C3,3.34314575 4.34314575,2 6,2 Z M12,11 C13.1045695,11 14,10.1045695 14,9 C14,7.8954305 13.1045695,7 12,7 C10.8954305,7 10,7.8954305 10,9 C10,10.1045695 10.8954305,11 12,11 Z M7.00036205,16.4995035 C6.98863236,16.6619875 7.26484009,17 7.4041679,17 C11.463736,17 14.5228466,17 16.5815,17 C16.9988413,17 17.0053266,16.6221713 16.9988413,16.5 C16.8360465,13.4332455 14.6506758,12 11.9907452,12 C9.36772908,12 7.21569918,13.5165724 7.00036205,16.4995035 Z" fill="#000000"/>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{asset('admin/customers/create')}}">Ajouter</a></li>
                            <li><a href="{{asset('admin/customers')}}">Tous</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="ai-icon" href="{{asset('admin/emplacements')}}" aria-expanded="false">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<span class="nav-text">Emplacements</span>
						</a>
                    ...
                    <li><a class="ai-icon" href="{{ asset('admin/pos') }}" aria-expanded="false">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                                <path d="M2,6 L21,6 C21.5522847,6 22,6.44771525 22,7 L22,17 C22,17.5522847 21.5522847,18 21,18 L2,18 C1.44771525,18 1,17.5522847 1,17 L1,7 C1,6.44771525 1.44771525,6 2,6 Z M11.5,16 C13.709139,16 15.5,14.209139 15.5,12 C15.5,9.790861 13.709139,8 11.5,8 C9.290861,8 7.5,9.790861 7.5,12 C7.5,14.209139 9.290861,16 11.5,16 Z" fill="#000000" opacity="0.3" transform="translate(11.500000, 12.000000) rotate(-345.000000) translate(-11.500000, -12.000000) "/>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © <a href="#" target="_blank">Tapino</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
