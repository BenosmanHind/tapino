                                            ...
                                            <tr>
                                                <td style="width:  30%">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="0" value="{{ $productline->width }}" name="width[]">
                                                ...
                                                <td  style="width: 30%">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="0" value="{{ $productline->height }}" name="height[]">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">m</span>
                                                        </div>
                                                    </div>
