                    ...
                    <div class="card-body">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label>Emplacement :</label>
                                            <select  id="select-content-individuel"  class="default-select form-control wide selectpicker" name="emplacement" >
                                                ...
                                                <option value="{{$empalcement->ticket}}">{{$empalcement->ticket}}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label>Qte alert:</label>
                                        <input type="number"  class="form-control input-default control-number @error('qte_alert') is-invalid @enderror" value="{{old('qte_alert')}}" min="0" name="qte_alert" placeholder="0">
                                            @error('qte_alert')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control input-default control-number @error('price_1') is-invalid @enderror" value="{{old('price')}}" name="price_1" placeholder="0.00">
                                            @error('price_1')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control input-default control-number @error('price_2') is-invalid @enderror" value="{{old('price')}}" name="price_2" placeholder="0.00">
                                            @error('price_2')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control input-default control-number @error('price_3') is-invalid @enderror" value="{{old('price')}}" name="price_3" placeholder="0.00">
                                            @error('price_3')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
